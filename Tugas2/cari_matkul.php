...
<div class="container-fluid mt-4">
    <div class="row">
        <div class="col-md-12">
            <a href="#" onclick="loadPage('data_matkul')" class="btn btn-secondary mb-4">
                <i class="fas fa-arrow-left"></i> Kembali
            </a>
            <h2 class="mb-4">
                <i class="fas fa-search"></i> Pencarian Mata Kuliah
            </h2>
                    ...
                    <form id="searchForm" class="form-row align-items-center">
                        ...
                        <div class="col-md-5 mb-2">
                            <select name="searchBy" id="searchBy" class="form-control">
                                <option value="idmatkul">Cari berdasarkan Kode MK</option>
                                <option value="namamatkul">Cari berdasarkan Nama MK</option>
                                <option value="jns">Cari berdasarkan Jenis MK</option>
                            </select>
                        </div>
